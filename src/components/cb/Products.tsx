...
const defaultProducts: ProductItem[] = [
  { id: "cel-1", name: "Xiaomi Note 14 Pro+ 5G 12/512", price: 375, old: 410, img: fallbackProductImage, tag: "OFERTA", cat: "Celulares", stock: 50, compatibleModels: ["Universal"] },
  { id: "cel-2", name: "Xiaomi Note 14 Pro+ 5G 8/256", price: 320, old: 350, img: fallbackProductImage, tag: "OFERTA", cat: "Celulares", stock: 50, compatibleModels: ["Universal"] },
  { id: "cel-3", name: "Xiaomi Note 14 Pro 12/512", price: 280, old: 310, img: fallbackProductImage, tag: "HOT", cat: "Celulares", stock: 50, compatibleModels: ["Universal"] },
  { id: "cel-4", name: "Xiaomi Note 14 Pro 8/256", price: 235, old: 260, img: fallbackProductImage, cat: "Celulares", stock: 50, compatibleModels: ["Universal"] },
  { id: "cel-5", name: "Xiaomi Note 14 4G 8/256", price: 180, old: 204, img: fallbackProductImage, cat: "Celulares", stock: 50, compatibleModels: ["Universal"] },
  { id: "cel-6", name: "Xiaomi Note 14 4G 6/128", price: 160, old: 185, img: fallbackProductImage, cat: "Celulares", stock: 50, compatibleModels: ["Universal"] },
  { id: "cel-7", name: "Redmi 14C 16/256", price: 115, old: 138, img: fallbackProductImage, tag: "OFERTA", cat: "Celulares", stock: 50, compatibleModels: ["Universal"] },
  { id: "cel-8", name: "Redmi 15C 16/256", price: 150, old: 190, img: fallbackProductImage, cat: "Celulares", stock: 50, compatibleModels: ["Universal"] },
  { id: "cel-9", name: "Redmi 15C 4/128", price: 120, old: 145, img: fallbackProductImage, cat: "Celulares", stock: 50, compatibleModels: ["Universal"] },
  { id: "cel-10", name: "Redmi A5 8/128", price: 95, old: 120, img: fallbackProductImage, cat: "Celulares", stock: 50, compatibleModels: ["Universal"] },
  { id: "cel-11", name: "Poco X7 5G 12/512", price: 280, old: 309, img: fallbackProductImage, tag: "HOT", cat: "Celulares", stock: 50, compatibleModels: ["Universal"] },
  { id: "cel-12", name: "Poco X7 Pro 5G 8/256", price: 299, old: 327, img: fallbackProductImage, tag: "MAS VENDIDO", cat: "Celulares", stock: 50, compatibleModels: ["Universal"] },
  { id: "cel-13", name: "Samsung A56 5G 8/256", price: 335, old: 370, img: fallbackProductImage, tag: "MAS VENDIDO", cat: "Celulares", stock: 50, compatibleModels: ["Universal"] },
  { id: "cel-14", name: "Motorola Edge 50 Fusion 5G 8/256", price: 235, old: 265, img: fallbackProductImage, cat: "Celulares", stock: 50, compatibleModels: ["Universal"] },
  { id: "perf-1", name: "9PM", price: 45000, img: fallbackProductImage, tag: "MAS VENDIDO", cat: "Perfumes", stock: 50, compatibleModels: ["Universal"] },
  ...
  { id: "perf-8", name: "Aqua", price: 42000, img: fallbackProductImage, cat: "Perfumes", stock: 50, compatibleModels: ["Universal"] },
  ...
  { id: "perf-12", name: "Fakhar Negro", price: 41000, img: fallbackProductImage, cat: "Perfumes", stock: 50, compatibleModels: ["Universal"] },
  ...
  { id: "perf-17", name: "Eclaire", price: 44000, img: fallbackProductImage, cat: "Perfumes", stock: 50, compatibleModels: ["Universal"] },
  { id: "perf-18", name: "The Kingdom", price: 63000, img: fallbackProductImage, tag: "PREMIUM", cat: "Perfumes", stock: 50, compatibleModels: ["Universal"] },
  { id: "perf-19", name: "Club de Nuit Elixir", price: 63500, img: fallbackProductImage, tag: "PREMIUM", cat: "Perfumes", stock: 50, compatibleModels: ["Universal"] },
  { id: "perf-20", name: "Bharara King EDP 100ml", price: 75000, img: fallbackProductImage, tag: "PREMIUM", cat: "Perfumes", stock: 50, compatibleModels: ["Universal"] },
  ...
  { id: "st-2", name: "Vaso Cafetero 500ml con Sensor de Temperatura", price: 13400, img: fallbackProductImage, tag: "HOT", cat: "Stanley", stock: 50, compatibleModels: ["Universal"] },
  { id: "st-3", name: "Botella con Pico 350ml", price: 11000, img: fallbackProductImage, cat: "Stanley", stock: 50, compatibleModels: ["Universal"] },
  ...
  { id: "st-8", name: "Termo Stanley + Mate + Bombilla", price: 24500, img: fallbackProductImage, tag: "MAS VENDIDO", cat: "Stanley", stock: 50, compatibleModels: ["Universal"] },
  ...
  { id: "rel-2", name: "Apple Watch", price: 31000, img: fallbackProductImage, tag: "MAS VENDIDO", cat: "Relojes", stock: 50, compatibleModels: ["Universal"] },
  ...
  { id: "acc-3", name: "Vidrios Templados iPhone 11-17 Pro Max", price: 1930, img: fallbackProductImage, tag: "HOT", cat: "Accesorios", stock: 50, compatibleModels: ["Universal"] },
  ...
  { id: "acc-6", name: "Battery Pack", price: 15500, img: fallbackProductImage, tag: "PREMIUM", cat: "Accesorios", stock: 50, compatibleModels: ["Universal"] },
  ...
  { id: "may-2", name: "AirPods Max", price: 35000, img: fallbackProductImage, tag: "PREMIUM", cat: "Mayorista", stock: 50, compatibleModels: ["Universal"] },
  ...
  { id: "may-5", name: "JBL Flip 6", price: 34000, img: fallbackProductImage, tag: "MAS VENDIDO", cat: "Mayorista", stock: 50, compatibleModels: ["Universal"] },
  { id: "may-6", name: "JBL Flip 7", price: 37000, img: fallbackProductImage, tag: "NUEVO", cat: "Mayorista", stock: 50, compatibleModels: ["Universal"] },
  ...
  { id: "may-9", name: "Camara Foco 360?", price: 18950, img: fallbackProductImage, cat: "Mayorista", stock: 50, compatibleModels: ["Universal"] },
  ...
  { id: "may-11", name: "Aspiradora de Mano", price: 15000, img: fallbackProductImage, cat: "Mayorista", stock: 50, compatibleModels: ["Universal"] },
