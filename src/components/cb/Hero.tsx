...
export function Hero() {
  return (
    <section id="inicio" className="border-b border-border bg-[#F8F9FA]">
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 py-16 md:px-8 lg:grid-cols-[.9fr_1.1fr] lg:py-24">
        <div className="max-w-xl">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            ...
            <a href="#nosotros" className="inline-flex min-h-12 items-center justify-center rounded-lg border border-border bg-white px-6 py-3 text-sm font-semibold text-foreground transition-colors hover:border-primary hover:text-primary">Conocé SDT DROPS</a>
          </div>
        </div>
        <div className="overflow-hidden rounded-2xl border border-border bg-white shadow-[0_16px_45px_rgba(17,24,39,.08)]">
