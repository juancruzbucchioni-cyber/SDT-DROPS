    ...
    <section id="inicio" className="relative overflow-hidden border-b border-border bg-[#ECEFF3]">
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-8 px-4 py-10 sm:py-14 md:px-8 lg:grid-cols-[.9fr_1.1fr] lg:gap-12 lg:py-24">
        <div className="max-w-xl">
          ...
          <h1 className="hero-animate-title text-[2.15rem] font-semibold leading-[1.08] tracking-[-0.035em] text-foreground sm:text-5xl lg:text-6xl">Productos que mueven tu negocio.</h1>
          ...
          <div className="hero-animate-buttons mt-8 flex flex-col gap-3 sm:flex-row">
            <a href="#productos" className="cta-enhanced inline-flex min-h-12 items-center justify-center gap-2 rounded-lg bg-primary px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-primary/90">Ver productos <ArrowRight className="h-4 w-4" /></a>
        ...
        <div className="hero-animate-image flex aspect-[16/8] items-center overflow-hidden rounded-2xl border border-[#162B52] bg-[#010713] shadow-[0_16px_45px_rgba(17,24,39,.12)]">
