...
export function TrustSection() {
  return (
    <section id="nosotros" className="border-y border-border bg-[#DCE7F7] py-14">
...
export function CatalogCta() {
  return (
    <section className="bg-[#E4ECF8] py-16 sm:py-20"><div className="mx-auto max-w-7xl px-4 md:px-8"><div className="flex flex-col items-start justify-between gap-6 rounded-2xl bg-primary px-6 py-10 text-white sm:px-10 md:flex-row md:items-center"><h2 className="max-w-2xl text-2xl font-semibold normal-case tracking-tight sm:text-3xl">Encontrá productos para hacer crecer tu negocio.</h2><a href="#productos" className="inline-flex min-h-11 shrink-0 items-center justify-center rounded-lg bg-[#EAF1FC] px-5 py-2.5 text-sm font-semibold text-primary hover:bg-[#DCE8FA]">Explorar catálogo</a></div></div></section>
  );
}
